    ...
    postData({
      body: {
        address: userInfo?.address ? {
          city: userInfo.address.city?.name || userInfo.address.city || '',
          area: userInfo.address.area?.name || userInfo.address.area || '',
          postalCode: userInfo.address.postalCode || '',
          provinces: userInfo.address.province?.name || userInfo.address.province || '',
            ...
            <View className="py-2 space-y-3">
                ...
                <View className="flex flex-row items-center justify-evenly">
                  <Link href="/cart" asChild>
                    <Pressable className="flex flex-col items-center gap-y-2">
                      ...
                      />
                      <Text className="font-normal text-red-300">carro de la compra</Text>
                    </Pressable>
                  </Link>
                  ...
                  <View className="flex flex-col items-center gap-y-2">
                    ...
                    />
                    <Text className="text-base font-normal text-red-500">Método de pago</Text>
                  </View>
                </View>
              </View>
              ...
              <View className="flex flex-row items-center px-3 py-4 gap-x-3">
                ...
                {userInfo?.address ? (
                  ...
                  <Text className="text-black">Complete la dirección</Text>
                )}
                <ChangeAddress />
              </View>
              <View className="section-divide-y h-2 bg-gray-100" />
              ...
              <View className="px-2 py-4 mx-3 border border-gray-200 rounded-lg">
                <View className="flex flex-row items-start mb-5">
                  ...
                  />
                  <View>
                    <Text className="text-base text-black">entrega normal</Text>
                  ...
                  <View className="inline-block px-2 py-1 ml-3 bg-gray-100 rounded-lg h-auto">
                    <Text className="text-neutral-600">{formatNumber(totalItems)} elementos</Text>
                  </View>
                </View>
              ...
              <View className="lg:border lg:border-gray-200 lg:rounded-md lg:h-fit">
                ...
                <View className="px-3 py-2 space-y-3">
                  <RadioButton.Group
                    ...
                    value={paymentMethod}
                  >
                    <RadioButton.Item label="pagar en línea" value="pagar en línea" />
                    <RadioButton.Item label="tarjeta bancaria" value="tarjeta bancaria" />
                  </RadioButton.Group>
                </View>
              </View>
            </View>
