...
import { translateProductName } from '@/utils/translations' // Asegúrate de que la ruta sea correcta
              ...
              ? categories
                  ...
                  .map(levelOneCategory => (
                    ...
                    >
                      ...
                      <Text className="text-gray-700">{getTranslatedName(levelOneCategory.name)}</Text>
                    </TouchableOpacity>
                  ))
              : null}
          </ScrollView>
                          ...
                          >
                            <Pressable>
                              <Text className="break-words py-2 text-neutral-900">
                                {getTranslatedName(levelTwoCategory.name)}
                              </Text>
                            </Pressable>
                          </Link>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <Text className="text-gray-700">
                                      {getTranslatedName(levelThreeCategory.name)}
                                    </Text>
                                  </TouchableOpacity>
                                </Link>
                              ))}
