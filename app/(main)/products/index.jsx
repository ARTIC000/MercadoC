          ...
          <View id="_products" className="w-full h-[100%] flex px-4 py-2 mt-2">
            ...
            <View className="divide-y-2 divide-neutral-200">
              ...
              <View className="flex flex-row justify-between py-2">
                <Text className="text-base text-neutral-600">Todos los productos</Text>

                <Text className="text-base text-neutral-600">
                  {data?.data?.productsLength} elementos
                </Text>
              </View>
            </View>
            {/* Products */}
            ...
            {data && data?.data?.products.length > 0 ? (
              ...
              <Text className="text-center text-red-500">No se encontró ningún producto</Text>
            )}
          </View>
        </View>
      </View>
