    ...
    <>
      <View className="px-3 py-3 space-y-4" id="_productReviews">
        <View className="flex flex-row items-center justify-between">
          <Text className="">Evaluación del producto</Text>
          <Text className="text-xs text-sky-500">{numReviews} opiniones</Text>
        </View>
        <View className="mb-2">
          <Pressable
          ...
          >
            ...
            <Text className="text-sm text-black ml-2">Escribe tu reseña para este producto</Text>
            <Icons.MaterialIcons name="keyboard-arrow-right" size={24} className="ml-auto icon" />
          </Pressable>
          <Text className="mt-6 text-xs text-gray-500">
            Después de la confirmación del envío, se otorgarán puntos.
          </Text>
        </View>
        <ShowWrapper
          error={error}
