    ...
    <>
      <View className=" px-3">
        <Pressable className="flex flex-row items-center gap-x-1" onPress={filtersHandlers.open}>
          ...
          <Text className="text-base text-neutral-600">filtrar</Text>
        </Pressable>
      </View>
      <Modal
        isShow={isFilters}
      ...
      >
        ...
        >
          <Modal.Header onClose={filtersHandlers.close}>filtrar</Modal.Header>
          <Modal.Body>
            ...
            <View className="divide-y">
              <View className="flex flex-row justify-between items-center py-2.5">
                <Text className="font-medium text-gray-700 w-3/4">Solo artículos en stock</Text>
                <Switch
              ...
              <View className="flex flex-row justify-between items-center py-2.5">
                <Text className="font-medium text-gray-700 w-3/4">Sólo especiales</Text>
                <Switch
              ...
              <View className="py-4">
                <Text className="font-medium text-gray-700">gama de precios</Text>
                ...
                <View className="flex flex-row items-center justify-between mt-2 mb-4 gap-x-1">
                  <Text className="text-base">llegar</Text>
